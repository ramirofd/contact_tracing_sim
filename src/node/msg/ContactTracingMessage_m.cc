...
#include <memory>
#include <type_traits>
#include "ContactTracingMessage_m.h"
...
ContactTracingMessage::ContactTracingMessage(const ContactTracingMessage& other) : ::omnetpp::cMessage(other)
{
    copy(other);
}

ContactTracingMessage::~ContactTracingMessage()
{
}

ContactTracingMessage& ContactTracingMessage::operator=(const ContactTracingMessage& other)
{
...
const inet::Coord& ContactTracingMessage::getCoord() const
{
    return this->coord;
}

void ContactTracingMessage::setCoord(const inet::Coord& coord)
{
    this->coord = coord;
}
...
class ContactTracingMessageDescriptor : public omnetpp::cClassDescriptor
{
  ...
  public:
    ...
    virtual ~ContactTracingMessageDescriptor();
...
Register_ClassDescriptor(ContactTracingMessageDescriptor)

ContactTracingMessageDescriptor::ContactTracingMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(ContactTracingMessage)), "omnetpp::cMessage")
{
    propertyNames = nullptr;
}

ContactTracingMessageDescriptor::~ContactTracingMessageDescriptor()
{
    delete[] propertyNames;
}

bool ContactTracingMessageDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<ContactTracingMessage *>(obj)!=nullptr;
}

const char **ContactTracingMessageDescriptor::getPropertyNames() const
{
    if (!propertyNames) {
...
const char *ContactTracingMessageDescriptor::getProperty(const char *propertyName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    return base ? base->getProperty(propertyName) : nullptr;
}

int ContactTracingMessageDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    return base ? 2+base->getFieldCount() : 2;
}

unsigned int ContactTracingMessageDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
const char *ContactTracingMessageDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
int ContactTracingMessageDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    int baseIndex = base ? base->getFieldCount() : 0;
    if (strcmp(fieldName, "coord") == 0) return baseIndex + 0;
    if (strcmp(fieldName, "data") == 0) return baseIndex + 1;
    return base ? base->findField(fieldName) : -1;
}

const char *ContactTracingMessageDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
const char **ContactTracingMessageDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
const char *ContactTracingMessageDescriptor::getFieldProperty(int field, const char *propertyName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
int ContactTracingMessageDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void ContactTracingMessageDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    ContactTracingMessage *pp = omnetpp::fromAnyPtr<ContactTracingMessage>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'ContactTracingMessage'", field);
    }
}

const char *ContactTracingMessageDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
std::string ContactTracingMessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    ContactTracingMessage *pp = omnetpp::fromAnyPtr<ContactTracingMessage>(object); (void)pp;
    switch (field) {
        case FIELD_coord: return "";
        case FIELD_data: return "";
        default: return "";
    }
}

void ContactTracingMessageDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
omnetpp::cValue ContactTracingMessageDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void ContactTracingMessageDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
const char *ContactTracingMessageDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
omnetpp::any_ptr ContactTracingMessageDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void ContactTracingMessageDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
